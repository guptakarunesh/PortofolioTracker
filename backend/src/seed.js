...
const run = db.transaction(() => {
  ...
  [
    { user_id: userId, category: 'Banking & Deposits', sub_category: 'Savings', name: 'HDFC Savings', institution: 'HDFC Bank', account_ref: 'XXXX1234', quantity: 1, invested_amount: 50000, current_value: 50000, notes: 'Primary Account', metadata: JSON.stringify({ interestRate: 3.5 }), updated_at: t },
    { user_id: userId, category: 'Banking & Deposits', sub_category: 'FD', name: 'SBI FD', institution: 'SBI', account_ref: 'XXXX5678', quantity: 1, invested_amount: 200000, current_value: 200000, notes: 'Maturity 15-Aug-2026', metadata: JSON.stringify({ interestRate: 7.1 }), updated_at: t },
    { user_id: userId, category: 'Banking & Deposits', sub_category: 'PPF', name: 'PPF Account', institution: 'SBI', account_ref: 'XXXX3456', quantity: 1, invested_amount: 500000, current_value: 500000, notes: 'Annual Contribution', metadata: JSON.stringify({ interestRate: 7.1 }), updated_at: t },
    { user_id: userId, category: 'Market Investments', sub_category: 'Mutual Funds', name: 'HDFC Flexi Cap', institution: 'HDFC MF', account_ref: '12345/67', quantity: 1000.5, invested_amount: 750000, current_value: 850675.13, notes: 'SIP 10,000', metadata: JSON.stringify({ nav: 850.25 }), updated_at: t },
    { user_id: userId, category: 'Market Investments', sub_category: 'Stocks', name: 'RELIANCE', institution: 'NSE', account_ref: 'ZERODHA', quantity: 50, invested_amount: 120000, current_value: 142500, notes: 'Direct equity', metadata: JSON.stringify({ currentPrice: 2850 }), updated_at: t },
    { user_id: userId, category: 'Precious Metals', sub_category: 'Gold', name: 'Physical Jewelry', institution: 'Personal', account_ref: 'HOME_LOCKER', quantity: 50, invested_amount: 225000, current_value: 325000, notes: 'Home Locker', metadata: JSON.stringify({ ratePerGram: 6500 }), updated_at: t },
    ...
    { user_id: userId, category: 'Insurance (Cash Value)', sub_category: 'Endowment', name: 'LIC Endowment', institution: 'LIC', account_ref: 'LIC987654', quantity: 1, invested_amount: 350000, current_value: 350000, notes: 'Cash/Surrender Value', metadata: '{}', updated_at: t },
    { user_id: userId, category: 'Other Assets', sub_category: 'Vehicle', name: 'Honda City 2022', institution: 'Self', account_ref: 'DL-XX-XXXX', quantity: 1, invested_amount: 1200000, current_value: 800000, notes: 'Depreciating asset', metadata: '{}', updated_at: t }
