...
const translations = {
  ...
  hi: {
    ...
    'Allocation': 'एलोकेशन',
    'Total': 'कुल',
    'Unnamed asset': 'बिना नाम वाला एसेट',
    'No assets in this bucket yet.': 'इस बकेट में अभी कोई एसेट नहीं है।',
    'Asset Type': 'एसेट प्रकार',
    'Asset Type: {value}': 'एसेट प्रकार: {value}',
    'Select asset type': 'एसेट प्रकार चुनें',
    'Asset Type is required.': 'एसेट प्रकार आवश्यक है।',
    'Choose the sub type within the selected main category.': 'चुनी गई मुख्य श्रेणी के अंदर उप-प्रकार चुनें।',
    ...
    'Net Worth Trend (Last 12 Months)': 'नेट वर्थ ट्रेंड (पिछले 12 महीने)',
